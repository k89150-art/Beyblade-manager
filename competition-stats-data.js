...
export const STATUS = Object.freeze({ranked: '有排名', unranked_or_insufficient_sample: '未排名／樣本不足', no_statistics: '目前無可用競賽統計', no_data: '目前無可用競賽統計', no_available_competition_statistics: '目前無可用競賽統計'});
